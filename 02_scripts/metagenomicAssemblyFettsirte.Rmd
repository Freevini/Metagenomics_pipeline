...
Different binning approachs have been applied. Amongst the most common ones are: the Tetranucleotide binning [@Iverson2012] and the coverage based binning [@Albersen2013]. However it has been noticed that both entities applie only to entities with a extreme skew. Further it is unlikely that both the coverage aswell as the tetranucleotide distribution is consisten over the entire genome. Therefore these methods might additionally bias the assembly. 
